...
function ot(t, n, e, i) {
  if (t[2] && i) {
    ...
    if (typeof r == "object") {
      ...
      for (let o = 0; o < c; o += 1) a[o] = n.dirty[o] | r[o];
      return a;
    }
    return n.dirty | r;
  }
...
function K(t) {
  ...
  for (let l = e[r] + 1; l != 0; l = i[l - 1]) {
    for (a.push(n[l - 1]); o >= l; o--) c.push(n[o]);
    o--;
  }
  for (; o >= 0; o--) c.push(n[o]);
  a.reverse(), c.sort((l, u) => l.claim_order - u.claim_order);
  for (let l = 0, u = 0; l < c.length; l++) {
    for (; u < a.length && c[l].claim_order >= a[u].claim_order; ) u++;
    ...
    ((u.ctx = e
      ? e(t, n.props || {}, (f, x, ...A) => {
          ...
          return (
            u.ctx &&
              r(u.ctx[f], (u.ctx[f] = j)) &&
              (!u.skip_bound && u.bound[f] && u.bound[f](j), s && ct(t, f)),
            x
          );
        })
      : []),
