...
window.fetch = (e, n) => (
  (e instanceof Request
    ? e.method
    : (n == null ? void 0 : n.method) || "GET") !== "GET" && oe.delete(Le(e)),
  Qe(e, n)
);
const oe = new Map();
function _t(e) {
...
function wt(e, n) {
  ...
  if (r != null && r.textContent) {
    ...
    return (
      _ && oe.set(i, { body: u, init: f, ttl: 1e3 * Number(_) }),
...
function Le(e, n) {
  ...
  if ((n != null && n.headers) || (n != null && n.body)) {
    ...
    n.headers && u.push([...new Headers(n.headers)].join(",")),
      n.body &&
        (typeof n.body == "string" || ArrayBuffer.isView(n.body)) &&
        u.push(n.body),
      (r += `[data-hash="${mt(...u)}"]`);
  }
  return r;
                ...
                return (
                  ...
                  _.map((p, h) => {
                    if (h % 2) {
                      if (p.startsWith("x+"))
                        return Se(
                          String.fromCharCode(parseInt(p.slice(2), 16))
                        );
                      if (p.startsWith("u+"))
                        return Se(
                          String.fromCharCode(
                      ...
                      if (!g)
                        throw new Error(
                          `Invalid param: ${p}. Params and matcher names can only have underscores and alphanumeric characters.`
                        );
                      const [, N, $, A, D] = g;
                      return (
                        n.push({
...
function At({ nodes: e, server_loads: n, dictionary: i, matchers: r }) {
  ...
  return Object.entries(i).map(([s, [p, h, g]]) => {
    ...
    return (
      (A.errors.length = A.layouts.length =
        Math.max(A.errors.length, A.layouts.length)),
      A
    );
  });
  function f(s) {
...
function Ue(e, n = ve) {
  ...
  function u(s) {
    if (st(e, s) && ((e = s), i)) {
      const p = !Y.length;
      for (const h of r) h[1](), Y.push(h, e);
      if (p) {
        for (let h = 0; h < Y.length; h += 2) Y[h][0](Y[h + 1]);
        Y.length = 0;
      }
    }
  }
  ...
  function _(s, p = ve) {
    ...
    return (
      ...
      s(e),
      () => {
        r.delete(h), r.size === 0 && i && (i(), (i = null));
      }
    );
  }
  return { set: u, update: f, subscribe: _ };
}
var Xe;
const F =
  ((Xe = globalThis.__sveltekit_ta7oe5) == null ? void 0 : Xe.base) ?? "";
var Ze;
const Rt =
    ((Ze = globalThis.__sveltekit_ta7oe5) == null ? void 0 : Ze.assets) ?? F,
  It = "1708286388494",
...
function Ae(e, n) {
  ...
  return { url: i, external: u, target: r, download: f };
}
function ue(e) {
  let n = null,
    i = null,
...
function Je(e) {
  ...
  return { notify: r, set: u, subscribe: f };
}
function Lt() {
...
function jt(e, n) {
  ...
  function u(f, _ = !1) {
    ...
    if (f === Nt) return -1 / 0;
    if (f === Tt) return -0;
    if (_) throw new Error("Invalid input");
    if (f in r) return r[f];
    const s = i[f];
    if (!s || typeof s != "object") r[f] = s;
    else if (Array.isArray(s))
      if (typeof s[0] == "string") {
        const p = s[0],
          h = n == null ? void 0 : n[p];
        if (h) return (r[f] = h(u(s[1])));
        switch (p) {
          case "Date":
            r[f] = new Date(s[1]);
            break;
          case "Set":
            const g = new Set();
            r[f] = g;
            for (let A = 1; A < s.length; A += 1) g.add(u(s[A]));
            break;
          case "Map":
            const N = new Map();
            r[f] = N;
            for (let A = 1; A < s.length; A += 2) N.set(u(s[A]), u(s[A + 1]));
            break;
          case "RegExp":
          ...
          case "null":
            ...
            r[f] = $;
            for (let A = 1; A < s.length; A += 2) $[s[A]] = u(s[A + 1]);
            break;
          default:
  ...
  for (const r in e)
    if (typeof ((i = e[r]) == null ? void 0 : i.then) == "function")
      return Object.fromEntries(
        await Promise.all(Object.entries(e).map(async ([u, f]) => [u, await f]))
      );
  return e;
}
class re {
...
class Ke {
  constructor(n, i) {
    (this.status = n), (this.location = i);
  }
}
class Vt extends Error {
  constructor(n) {
    super(), (this.status = 404), (this.message = `Not found: ${n}`);
  }
}
...
const z = { url: Je({}), page: Je({}), navigating: Ue(null), updated: Lt() },
  H = et(nt) ?? {},
  ne = et(tt) ?? {};
function Re(e) {
  H[e] = ae();
...
function Gt(e, n) {
  ...
  let g = { branch: [], error: null, url: null },
    ...
    K = !1,
    M,
    x = (qe = history.state) == null ? void 0 : qe[q];
  x ||
    ((x = Date.now()),
    history.replaceState({ ...history.state, [q]: x }, "", location.href));
  const ge = H[x];
  ge && ((history.scrollRestoration = "manual"), scrollTo(ge.x, ge.y));
  let G, W, Z;
  async function Oe() {
    if (((Z = Z || Promise.resolve()), await Z, !Z)) return;
    Z = null;
    ...
    if (a === W && c) {
      ...
      c.props.page !== void 0 && (G = c.props.page), M.$set(c.props);
    }
  }
  function xe(t) {
    s.some((l) => (l == null ? void 0 : l.snapshot)) &&
      (ne[t] = s.map((l) => {
        var a;
        return (a = l == null ? void 0 : l.snapshot) == null
          ? void 0
          : a.capture();
      }));
  }
  ...
  async function ie(
    ...
    return (
      typeof t == "string" && (t = new URL(t, ze(document))),
      fe({
        url: t,
        scroll: l ? ae() : null,
        keepfocus: c,
        redirect_count: m,
        details: { state: o, replaceState: a },
        nav_token: b,
        accepted: () => {
          d && (K = !0);
        },
  ...
  async function Te(t) {
    return (
      (p = {
        id: t.id,
        promise: we(t).then(
          (l) => (l.type === "loaded" && l.state.error && (p = null), l)
        ),
      }),
      p.promise
    );
  ...
  async function se(...t) {
    const a = i
      .filter((c) => t.some((o) => c.exec(o)))
      .map((c) =>
        Promise.all(
          [...c.layouts, c.leaf].map((o) => (o == null ? void 0 : o[1]()))
        )
      );
    await Promise.all(a);
  }
  function je(t) {
    ...
    l && l.remove(),
      ...
      (M = new e.root({
        target: n,
        props: { ...t.props, stores: z, components: s },
        hydrate: !0,
      })),
      Pe(x);
    const a = {
      ...
      to: {
        params: g.params,
        route: { id: ((c = g.route) == null ? void 0 : c.id) ?? null },
    ...
    h.after_navigate.forEach((o) => o(a)), ($ = !0);
  }
  async function Q({
    url: t,
    params: l,
    ...
    (t.pathname = ct(t.pathname, b)), (t.search = t.search);
    const E = {
      type: "loaded",
      state: { url: t, params: l, branch: a, error: o, route: d },
      props: { constructors: $t(a).map((y) => y.node.component) },
    };
    ...
    for (let y = 0; y < Math.max(a.length, g.branch.length); y += 1) {
      const w = a[y],
        O = g.branch[y];
      (w == null ? void 0 : w.data) !== (O == null ? void 0 : O.data) &&
        (L = !0),
        w &&
          ((v = { ...v, ...w.data }),
          L && (E.props[`data_${R}`] = v),
  ...
  async function me({
    ...
    if ((v = E.universal) != null && v.load) {
      ...
      const y = {
        route: new Proxy(o, { get: (w, O) => ((b.route = !0), w[O]) }),
        params: new Proxy(c, { get: (w, O) => (b.params.add(O), w[O]) }),
    ...
    return {
      ...
      server: d,
      universal:
        (L = E.universal) != null && L.load
          ? { type: "data", data: m, uses: b }
          : null,
      data: m ?? (d == null ? void 0 : d.data) ?? null,
      slash:
        a.pathname === F || a.pathname === F + "/"
          ? "always"
          : ((R = E.universal) == null ? void 0 : R.trailingSlash) ??
  ...
  function $e(t, l, a, c, o) {
    if (K) return !0;
    if (!c) return !1;
    if ((c.parent && t) || (c.route && l) || (c.url && a)) return !0;
    for (const d of c.params) if (o[d] !== g.params[d]) return !0;
  ...
  async function we({ id: t, invalidating: l, url: a, params: c, route: o }) {
    ...
    const y = E.map((k, I) => {
      ...
      const S = g.branch[I],
        j =
          !!(k != null && k[0]) &&
          ((S == null ? void 0 : S.loader) !== k[1] ||
            $e(U, R, L, (B = S.server) == null ? void 0 : B.uses, c));
      return j && (U = !0), j;
    });
    if (y.some(Boolean)) {
      try {
        ...
        return ce({
          ...
          error: await te(k, { url: a, params: c, route: { id: o.id } }),
          url: a,
          route: o,
        });
      }
    ...
    const T = E.map(async (k, I) => {
      ...
      if (
        (!j || j.type === "skip") &&
        k[1] === (S == null ? void 0 : S.loader) &&
        !$e(O, R, L, (ye = S.universal) == null ? void 0 : ye.uses, c)
      )
        return S;
      ...
      return me({
        ...
        server_data_node: _e(
          ...
          k[0] ? (S == null ? void 0 : S.server) : void 0
        ),
      });
    });
    for (const k of T) k.catch(() => {});
    const V = [];
    for (let k = 0; k < E.length; k += 1)
      if (E[k])
        try {
          ...
          if (I instanceof Ke)
            return { type: "redirect", location: I.location };
          let S = 500,
            j;
          if (w != null && w.includes(I)) (S = I.status ?? S), (j = I.error);
          else if (I instanceof re) (S = I.status), (j = I.body);
          else {
            if (await z.updated.check()) return await J(a);
            j = await te(I, { params: c, url: a, route: { id: o.id } });
          }
  ...
  async function ce({ status: t, error: l, url: a, route: c }) {
    ...
    if (e.server_loads[0] === 0)
      try {
        ...
        (a.origin !== he || a.pathname !== location.pathname || N) &&
          (await J(a));
      }
    const b = await me({
        loader: r,
  ...
  function De({ url: t, type: l, intent: a, delta: c }) {
    ...
    const m = {
      ...d.navigation,
      cancel: () => {
        (o = !0), d.reject(new Error("navigation was cancelled"));
      },
    };
    return P || h.before_navigate.forEach((b) => b(m)), o ? null : d;
  }
  async function fe({
    url: t,
    scroll: l,
    ...
    var T, V, k;
    const L = ee(t, !1),
      R = De({ url: t, type: d, delta: m, intent: L });
    if (!R) {
      v();
      return;
    }
    const U = x;
    E(), (P = !0), $ && z.navigating.set(R.navigation), (W = b);
    let y = L && (await we(L));
    if (!y) {
      if (de(t, F)) return await J(t);
      y = await Ve(
        t,
        { id: null },
    ...
    if (((t = (L == null ? void 0 : L.url) || t), W !== b))
    ...
    if (y.type === "redirect")
      ...
      else return ie(new URL(y.location, t).href, {}, c + 1, b), !1;
    else
      ((T = y.props.page) == null ? void 0 : T.status) >= 400 &&
    ...
    if (
      ...
      (V = y.props.page) != null &&
        ...
        (t.pathname = (k = y.props.page) == null ? void 0 : k.url.pathname),
      o)
    ) {
      ...
      if (
        ...
        let S = x + 1;
        for (; ne[S] || H[S]; ) delete ne[S], delete H[S], (S += 1);
      }
    }
    if (((p = null), $)) {
      (g = y.state), y.props.page && (y.props.page.url = t);
      const I = (
        await Promise.all(h.on_navigate.map((S) => S(R.navigation)))
      ).filter((S) => typeof S == "function");
      if (I.length > 0) {
        let S = function () {
          h.after_navigate = h.after_navigate.filter((j) => !I.includes(j));
        };
        I.push(S), h.after_navigate.push(...I);
      }
      M.$set(y.props);
    } else je(y);
    ...
    const O =
      document.activeElement !== w && document.activeElement !== document.body;
    !a && !O && Ie(),
      (A = !0),
  ...
  async function Ve(t, l, a, c) {
    return t.origin === he && t.pathname === location.pathname && !N
      ? await ce({ status: c, error: a, url: t, route: l })
      : await J(t);
  }
  function it() {
    let t;
    ...
    f.addEventListener("mousedown", l),
      f.addEventListener("touchstart", l, { passive: !0 });
    const a = new IntersectionObserver(
      (d) => {
        for (const m of d)
          m.isIntersecting &&
            (se(le(new URL(m.target.href))), a.unobserve(m.target));
      },
      { threshold: 0 }
    );
    function c(d, m) {
    ...
    function o() {
      ...
      for (const d of f.querySelectorAll("a")) {
        ...
        const v = ue(d);
        v.reload ||
          (v.preload_code === pe.viewport && a.observe(d),
          v.preload_code === pe.eager && se(le(m)));
      }
    }
    h.after_navigate.push(o), o();
  }
  function te(t, l) {
    return t instanceof re
      ? t.body
      : e.hooks.handleError({ error: t, event: l }) ?? {
          message:
            l.route.id === null && t instanceof Vt
              ? "Not Found"
              : "Internal Error",
        };
  }
  return {
    ...
    invalidate_all: () => ((K = !0), Oe()),
    preload_data: async (t) => {
      const l = new URL(t, ze(document)),
        a = ee(l, !1);
      if (!a)
        throw new Error(
          `Attempted to preload a URL that does not belong to this app: ${l}`
        );
      await Te(a);
    },
    preload_code: se,
    apply_action: async (t) => {
      if (t.type === "error") {
        ...
        if (o) {
          ...
          (g = d.state), M.$set(d.props), ke().then(Ie);
        }
      } else
        t.type === "redirect"
          ? ie(t.location, { invalidateAll: !0 }, 0)
          : (M.$set({
              form: null,
              page: { ...G, form: t.data, status: t.status },
            }),
            await ke(),
            M.$set({ form: t.data }),
            t.type === "success" && Ie());
    ...
    _start_router: () => {
      ...
      (history.scrollRestoration = "manual"),
          ...
          if ((Ne(), !P)) {
            const o = Ye(g, void 0, null, "leave"),
              d = {
                ...o.navigation,
                cancel: () => {
                  (c = !0), o.reject(new Error("navigation was cancelled"));
                },
              };
        ...
        f.addEventListener("click", (a) => {
          ...
          if (
            ...
            return;
          if (d || E.reload) {
            De({ url: o, type: "link" }) ? (P = !0) : a.preventDefault();
            return;
          }
          ...
          if (R !== void 0 && L === location.href.split("#")[0]) {
            if (g.url.hash === o.hash) {
              a.preventDefault(),
                (U = c.ownerDocument.getElementById(R)) == null ||
                  U.scrollIntoView();
              return;
            }
            if (((C = !0), Re(x), t(o), !E.replace_state)) return;
        ...
        f.addEventListener("submit", (a) => {
          ...
          if (((o == null ? void 0 : o.formMethod) || c.method) !== "get")
            return;
          const m = new URL(
            ((o == null ? void 0 : o.hasAttribute("formaction")) &&
              (o == null ? void 0 : o.formAction)) ||
              c.action
          );
          if (de(m, F)) return;
          const b = a.target,
          ...
          y &&
            U.append(y, (o == null ? void 0 : o.getAttribute("value")) ?? ""),
        ...
        addEventListener("popstate", async (a) => {
          var c, o;
          if (((W = {}), (c = a.state) != null && c[q])) {
            if (a.state[q] === x) return;
            const d = H[a.state[q]],
              m = new URL(location.href);
            if (
              ((o = g.url) == null ? void 0 : o.href.split("#")[0]) ===
              location.href.split("#")[0]
            ) {
              t(m), (H[x] = ae()), (x = a.state[q]), scrollTo(d.x, d.y);
              return;
            }
            const b = a.state[q] - x;
            await fe({
      ...
      function t(a) {
        (g.url = a), z.page.set({ ...G, url: a }), z.page.notify();
      }
    },
    _hydrate: async ({
      status: t = 200,
      ...
      ({ params: c = {}, route: o = { id: null } } = ee(b, !1) || {});
      let E;
      try {
        const v = a.map(async (U, y) => {
            const w = d[y];
            return (
              w != null && w.uses && (w.uses = ot(w.uses)),
              me({
                loader: e.nodes[U],
                url: b,
                params: c,
        ...
        if (R) {
          const U = R.layouts;
          for (let y = 0; y < U.length; y++) U[y] || L.splice(y, 0, void 0);
        }
        E = await Q({
          url: b,
          params: c,
        ...
        E = await ce({
          ...
          error: await te(v, { url: b, params: c, route: o }),
          url: b,
          route: o,
        });
      }
...
async function We(e, n) {
  ...
  if (
    ((u = r.headers.get("content-type")) != null &&
      u.includes("text/html") &&
      (await J(e)),
    !r.ok)
  )
...
`);
        ...
        if (((g = g.slice(D + 1)), P.type === "redirect")) return f(P);
        if (P.type === "data")
          (N = P.nodes) == null ||
            N.forEach((C) => {
              (C == null ? void 0 : C.type) === "data" &&
                ((C.uses = ot(C.uses)), (C.data = h(C.data)));
            }),
            f(P);
        else if (P.type === "chunk") {
          const { id: C, data: K, error: M } = P,
            x = _.get(C);
          _.delete(C), M ? x.reject(h(M)) : x.fulfil(h(K));
        }
      }
    }
  });
...
function Ie() {
  ...
  if (e) e.focus();
    ...
    if (r && r.type !== "None") {
      const u = [];
      for (let f = 0; f < r.rangeCount; f += 1) u.push(r.getRangeAt(f));
      setTimeout(() => {
        if (r.rangeCount === u.length) {
          for (let f = 0; f < r.rangeCount; f += 1) {
            const _ = u[f],
              s = r.getRangeAt(f);
            if (
              _.commonAncestorContainer !== s.commonAncestorContainer ||
              _.startContainer !== s.startContainer ||
              _.endContainer !== s.endContainer ||
              _.startOffset !== s.startOffset ||
              _.endOffset !== s.endOffset
            )
              return;
          }
          r.removeAllRanges();
  ...
  return (
    _.catch(() => {}),
    {
      navigation: {
        from: {
          params: e.params,
          route: { id: ((p = e.route) == null ? void 0 : p.id) ?? null },
          url: e.url,
        },
        to: i && {
          ...
          route: {
            id:
              ((h = n == null ? void 0 : n.route) == null ? void 0 : h.id) ??
              null,
          },
          url: i,
        },
...
async function Bt(e, n, i) {
  const r = Gt(e, n);
  Mt({ client: r }),
    i ? await r._hydrate(i) : r.goto(location.href, { replaceState: !0 }),
    r._start_router();
}
export { Bt as start };
